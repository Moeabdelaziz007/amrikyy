...
exports.users = (0, pg_core_1.pgTable)("users", {
    ...
    identityType: (0, pg_core_1.text)("identity_type").default("personal").notNull(), // personal, business, organization
...
exports.posts = (0, pg_core_1.pgTable)("posts", {
    id: (0, pg_core_1.varchar)("id").primaryKey().default((0, drizzle_orm_1.sql) `gen_random_uuid()`),
    tenantId: (0, pg_core_1.varchar)("tenant_id").notNull().references(() => exports.tenants.id),
    authorId: (0, pg_core_1.varchar)("author_id").notNull().references(() => exports.users.id),
...
exports.agentTemplates = (0, pg_core_1.pgTable)("agent_templates", {
    id: (0, pg_core_1.varchar)("id").primaryKey().default((0, drizzle_orm_1.sql) `gen_random_uuid()`),
    tenantId: (0, pg_core_1.varchar)("tenant_id").references(() => exports.tenants.id), // Can be null for global templates
    name: (0, pg_core_1.text)("name").notNull(),
...
exports.userAgents = (0, pg_core_1.pgTable)("user_agents", {
    ...
    tenantId: (0, pg_core_1.varchar)("tenant_id").notNull().references(() => exports.tenants.id),
    userId: (0, pg_core_1.varchar)("user_id").notNull().references(() => exports.users.id),
    templateId: (0, pg_core_1.varchar)("template_id").notNull().references(() => exports.agentTemplates.id),
    name: (0, pg_core_1.text)("name").notNull(),
    config: (0, pg_core_1.jsonb)("config").notNull(),
