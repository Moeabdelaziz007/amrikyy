...
class AIPersonalizationEngine {
     ...
     * Update preferences based on feedback
     */
    static async updatePreferencesFromFeedback(profile, itemId, feedback, context) {
        // Update preference confidence based on feedback
        const relevantPreferences = profile.preferences.filter(p => p.metadata?.itemId === itemId);
