  ...
  static async startSession(userId) {
    try {
      ...
      await (0, firestore_1.setDoc)(
        (0, firestore_1.doc)(
          firebase_1.db,
          firestore_types_1.COLLECTIONS.USER_SESSIONS,
          sessionId
        ),
        {
          ...session,
  ...
  static async getUserHistory(userId, options = {}) {
    try {
      let q = (0, firestore_1.query)(
        (0, firestore_1.collection)(
          firebase_1.db,
          firestore_types_1.COLLECTIONS.USER_HISTORY
        ),
        (0, firestore_1.where)('userId', '==', userId),
        (0, firestore_1.orderBy)('timestamp', 'desc'),
        (0, firestore_1.limit)(options.limit || 50)
      );
      if (options.actionType) {
        q = (0, firestore_1.query)(
          q,
          (0, firestore_1.where)('action.type', '==', options.actionType)
        );
      }
      if (options.category) {
        q = (0, firestore_1.query)(
          q,
          (0, firestore_1.where)('action.category', '==', options.category)
        );
      }
      if (options.startAfter) {
        q = (0, firestore_1.query)(
          q,
          (0, firestore_1.startAfter)(options.startAfter)
        );
      }
  ...
  static async getUserSessions(userId, limitCount = 20) {
    try {
      const q = (0, firestore_1.query)(
        ...
        (0, firestore_1.where)('userId', '==', userId),
        (0, firestore_1.orderBy)('startTime', 'desc'),
  ...
  static async generateUserAnalytics(userId, period = 'monthly') {
    try {
      ...
      await (0, firestore_1.setDoc)(
        (0, firestore_1.doc)(
          firebase_1.db,
          firestore_types_1.COLLECTIONS.USER_ANALYTICS,
  ...
  static async flushActionBuffer() {
    ...
    try {
      ...
      this.actionBuffer.forEach(action => {
        const docRef = (0, firestore_1.doc)(
          (0, firestore_1.collection)(
            firebase_1.db,
            firestore_types_1.COLLECTIONS.USER_HISTORY
          )
