...
import AdvancedAnalyticsService, { AutomatedReport } from '../../lib/advanced-analytics-service';

interface AutomatedReportsProps {
  userId: string;
}

export const AutomatedReports: React.FC<AutomatedReportsProps> = ({ userId }) => {
    ...
    try {
      ...
      const mockReports: AutomatedReport[] = [
        ...
        },
        {
          ...
          content: '# Monthly Security Report\n\n## Security Overview\n- Total alerts: 3\n- Critical issues: 0\n- Resolved issues: 3\n\n## Security Metrics\n- Threat detection rate: 99.8%\n- Response time: 2.3s',
          insights: [],
          metrics: [],
  ...
  const handleGenerateReport = async (type: 'daily' | 'weekly' | 'monthly' | 'quarterly') => {
    try {
      setLoading(true);
      const report = await AdvancedAnalyticsService.generateAutomatedReport(userId, type);
  ...
  const getReportIcon = (type: string) => {
    switch (type) {
      ...
      case 'monthly': return <BarChart3 className="h-5 w-5" />;
      case 'quarterly': return <TrendingUp className="h-5 w-5" />;
  ...
  const getReportColor = (type: string) => {
    switch (type) {
      ...
      case 'quarterly': return 'text-orange-600 bg-orange-50 border-orange-200';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button onClick={() => setShowScheduled(!showScheduled)} variant="outline" size="sm">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {filteredReports.length} {showScheduled ? 'scheduled' : 'generated'}
            </p>
          </CardContent>
        </Card>
      ...
      <Tabs defaultValue="reports" className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Recently generated automated reports</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {filteredReports.map((report) => (
                    <div 
                      ...
                      className={`p-4 border rounded-lg cursor-pointer transition-colors ${
                        selectedReport?.id === report.id ? 'bg-accent' : 'hover:bg-muted'
                      }`}
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                            ...
                            <span>Next: {report.scheduledFor.toLocaleString()}</span>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {selectedReport ? 'Selected report content' : 'Select a report to view content'}
                </CardDescription>
              </CardHeader>
              <CardContent>
                {selectedReport ? (
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="text-sm font-medium mb-2">Next Scheduled</div>
                      <div className="text-sm text-muted-foreground">
        ...
        <TabsContent value="scheduled" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {reports.filter(r => r.scheduledFor > new Date()).map((report) => (
                  <div key={report.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          Scheduled for: {report.scheduledFor.toLocaleString()}
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">Key performance metrics</div>
                      </div>
                    </div>
                    <Button size="sm" variant="outline">
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">User engagement patterns</div>
                      </div>
                    </div>
                    <Button size="sm" variant="outline">
                      <Plus className="h-4 w-4" />
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="text-sm font-medium">Security Report</div>
                        <div className="text-xs text-muted-foreground">Security alerts and threats</div>
                      </div>
                    </div>
                    <Button size="sm" variant="outline">
                      <Plus className="h-4 w-4" />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Create your own report templates</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure report notifications</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">Immediate notifications</div>
                    </div>
                    <input type="checkbox" defaultChecked className="rounded" />
                  </div>
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure report generation schedule</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
