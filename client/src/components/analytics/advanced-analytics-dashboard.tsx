...
> = ({ userId }) => {
  ...
  const loadAnalyticsData = async () => {
    try {
      ...
      const [insightsData, metricsData, alertsData, patternsData] =
        await Promise.all([
  ...
  const setupRealTimeUpdates = () => {
    ...
    const interval = setInterval(
      async () => {
        try {
          const realTimeData =
            await AdvancedAnalyticsService.getRealTimeAnalytics(userId);
...
const InsightsTab: React.FC<{ insights: PredictiveInsight[] }> = ({
  insights,
}) => {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <Card className="lg:col-span-2">
        <CardHeader>
          ...
          <CardDescription>
            Predictive insights based on user behavior analysis
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
...
const PerformanceTab: React.FC<{ metrics: PerformanceMetric[] }> = ({
  metrics,
}) => {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span
                    className={`text-sm font-medium ${getTrendColor(selectedMetric.trend)}`}
                  >
...
const PatternsTab: React.FC<{ patterns: UserBehaviorPattern[] }> = ({
  patterns,
}) => {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <Card className="lg:col-span-2">
        <CardHeader>
          ...
          <CardDescription>
            Identified user behavior patterns and trends
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <Badge
                          variant={
                            pattern.confidence > 80 ? 'default' : 'secondary'
                          }
                          className="text-xs"
                        >
          ...
          {selectedPattern ? (
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <Progress
                    value={selectedPattern.confidence}
                    className="flex-1"
                  />
                  <span
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                      <span>
                        Detected: {alert.timestamp.toLocaleDateString()}
                      </span>
                      {alert.resolvedAt && (
                        <span>
                          Resolved: {alert.resolvedAt.toLocaleDateString()}
                        </span>
                      )}
                    </div>
                  </div>
          ...
          {selectedAlert ? (
            <div className="space-y-4">
              ...
              <div>
                ...
                <Badge
                  variant={selectedAlert.resolved ? 'default' : 'destructive'}
                  className="text-xs"
                >
