          ...
          {statusLoading ? (
            ...
            <alert_1.Alert variant="destructive">
              <alert_1.AlertDescription>
                Failed to load Telegram bot status. Please check your
                configuration.
              </alert_1.AlertDescription>
            </alert_1.Alert>
          ) : botStatus ? (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  {botStatus.botInfo.id}
                </div>
                <div>
                  <span className="font-medium">Name:</span>{' '}
                  {botStatus.botInfo.firstName}
                </div>
                <div>
          ...
          {sendMessageMutation.isSuccess && (
            <alert_1.Alert>
              <alert_1.AlertDescription>
                ...
                {sendMessageMutation.data?.messageId}
              </alert_1.AlertDescription>
            </alert_1.Alert>
          )}
        </card_1.CardContent>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent className="space-y-4">
          ...
          <button_1.Button
            ...
            disabled={
              !broadcastMessage || !chatIds || broadcastMutation.isPending
            }
            className="w-full"
            variant="outline"
          >
          ...
          {broadcastMutation.isSuccess && (
            <alert_1.Alert>
              <alert_1.AlertDescription>
                ✅ Broadcast completed! Check results:{' '}
                {broadcastMutation.data?.results?.length} messages processed
              </alert_1.AlertDescription>
            </alert_1.Alert>
          )}
        </card_1.CardContent>
