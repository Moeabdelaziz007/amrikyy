...
function UserHistoryExample() {
  const {
    ...
    trackAIInteraction,
    trackError,
  } = (0, use_user_history_1.useUserHistory)();
  const { trackClick, trackView, trackCreate, trackUpdate, trackDelete } = (0,
  use_user_history_1.useInteractionTracking)('example-component');
  const { trackFormStart, trackFieldFocus, trackFormSubmit, trackFormAbandon } =
    (0, use_user_history_1.useFormTracking)('example-form');
    ...
    <card_1.Card className="max-w-2xl mx-auto">
      ...
      <card_1.CardContent className="space-y-4">
        <p className="text-muted-foreground">
          This component demonstrates how to use the user history tracking
          system. Click the buttons below to see different types of tracking in
          action.
        </p>
