...
const SmartLearningAI = () => {
    ...
    return (<card_1.Card>
      ...
      <card_1.CardContent>
        {isMobile ? (<accordion_1.Accordion type="single" collapsible>
            <accordion_1.AccordionItem value="item-1">
              <accordion_1.AccordionTrigger>Lesson 1: Introduction</accordion_1.AccordionTrigger>
            ...
            <accordion_1.AccordionItem value="item-2">
              <accordion_1.AccordionTrigger>Lesson 2: Advanced Topics</accordion_1.AccordionTrigger>
              <accordion_1.AccordionContent>
                <p>This is the content for lesson 2. It is optimized for mobile viewing.</p>
              </accordion_1.AccordionContent>
            </accordion_1.AccordionItem>
          </accordion_1.Accordion>) : (<div>
