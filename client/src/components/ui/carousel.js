...
const embla_carousel_react_1 = require("embla-carousel-react");
...
const Carousel = React.forwardRef(({ orientation = "horizontal", opts, setApi, plugins, className, children, ...props }, ref) => {
    ...
    return (<CarouselContext.Provider value={{
        ...
        <div ref={ref} onKeyDownCapture={handleKeyDown} className={(0, utils_2.cn)("relative", className)} role="region" aria-roledescription="carousel" {...props}>
          {children}
        </div>
...
const CarouselContent = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (<div ref={carouselRef} className="overflow-hidden">
      <div ref={ref} className={(0, utils_2.cn)("flex", orientation === "horizontal" ? "-ml-4" : "-mt-4 flex-col", className)} {...props}/>
    </div>);
});
...
const CarouselItem = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (<div ref={ref} role="group" aria-roledescription="slide" className={(0, utils_2.cn)("min-w-0 shrink-0 grow-0 basis-full", orientation === "horizontal" ? "pl-4" : "pt-4", className)} {...props}/>);
});
exports.CarouselItem = CarouselItem;
CarouselItem.displayName = "CarouselItem";
const CarouselPrevious = React.forwardRef(({ className, variant = "outline", size = "icon", ...props }, ref) => {
    const { orientation, scrollPrev, canScrollPrev } = useCarousel();
    return (<button_1.Button ref={ref} variant={variant} size={size} className={(0, utils_2.cn)("absolute  h-8 w-8 rounded-full", orientation === "horizontal"
