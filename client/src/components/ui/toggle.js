...
const Toggle = React.forwardRef(({ className, variant, size, ...props }, ref) => (<TogglePrimitive.Root ref={ref} className={(0, utils_2.cn)(toggleVariants({ variant, size, className }))} {...props}/>));
