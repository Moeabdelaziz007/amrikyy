...
exports.SidebarTrigger =
  ...
  exports.SidebarMenuSubItem =
  exports.SidebarMenuSubButton =
  exports.SidebarMenuSub =
  exports.SidebarMenuSkeleton =
  exports.SidebarMenuItem =
  exports.SidebarMenuButton =
  exports.SidebarMenuBadge =
...
const SidebarHeader = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={(0, utils_1.cn)('flex flex-col gap-2 p-2', className)}
      {...props}
    />
  );
});
...
const SidebarSeparator = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <separator_1.Separator
      ...
      className={(0, utils_1.cn)('mx-2 w-auto bg-sidebar-border', className)}
      {...props}
    />
  );
});
...
const SidebarGroupContent = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ...
    className={(0, utils_1.cn)('w-full text-sm', className)}
    {...props}
  />
));
...
const SidebarMenu = React.forwardRef(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    data-sidebar="menu"
    className={(0, utils_1.cn)('flex w-full min-w-0 flex-col gap-1', className)}
    {...props}
  />
));
...
const SidebarMenuItem = React.forwardRef(({ className, ...props }, ref) => (
  <li
    ...
    className={(0, utils_1.cn)('group/menu-item relative', className)}
    {...props}
  />
));
exports.SidebarMenuItem = SidebarMenuItem;
SidebarMenuItem.displayName = 'SidebarMenuItem';
const sidebarMenuButtonVariants = (0, class_variance_authority_1.cva)(
