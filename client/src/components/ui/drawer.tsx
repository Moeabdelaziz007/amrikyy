...
const DrawerOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <vaul_1.Drawer.Overlay
    ref={ref}
    className={(0, utils_1.cn)('fixed inset-0 z-50 bg-black/80', className)}
    {...props}
  />
));
...
const DrawerFooter = ({ className, ...props }) => (
  <div
    className={(0, utils_1.cn)('mt-auto flex flex-col gap-2 p-4', className)}
    {...props}
  />
);
