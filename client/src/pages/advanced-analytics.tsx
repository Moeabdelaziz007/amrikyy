      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Please log in to access advanced analytics.
          </p>
        </div>
      </div>
    );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl text-muted-foreground">
                AI-powered insights, predictive analytics, and comprehensive
                reporting
              </p>
            </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-sm font-medium mb-2">
                        User engagement is increasing. Expected session duration
                        will be longer in the next week.
                      </p>
                    ...
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-sm font-medium mb-2">
                        User retention is improving. Expected to maintain
                        engagement in the next month.
                      </p>
                      <div className="text-xs text-muted-foreground">
                    ...
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-sm font-medium mb-2">
                        High error rate detected (3.2%). Performance issues may
