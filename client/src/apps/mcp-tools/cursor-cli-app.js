      ...
      <card_1.Card className="glass-card">
        ...
        <card_1.CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <input_1.Input placeholder="Enter your command (e.g., 'explain this React component')" value={command} onChange={(e) => setCommand(e.target.value)}/>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <select_1.Select value={model} onValueChange={setModel}>
                ...
                <select_1.SelectContent>
                  <select_1.SelectItem value="claude-3.5-sonnet">Claude 3.5 Sonnet</select_1.SelectItem>
                  <select_1.SelectItem value="gpt-4">GPT-4</select_1.SelectItem>
                  <select_1.SelectItem value="claude-3-opus">Claude 3 Opus</select_1.SelectItem>
                </select_1.SelectContent>
              </select_1.Select>
            </div>
            ...
            <div className="space-y-2">
              ...
              <select_1.Select value={operationType} onValueChange={setOperationType}>
                <select_1.SelectTrigger>
                  <select_1.SelectValue />
                </select_1.SelectTrigger>
                <select_1.SelectContent>
                  <select_1.SelectItem value="explain">Explain</select_1.SelectItem>
                  <select_1.SelectItem value="refactor">Refactor</select_1.SelectItem>
                  <select_1.SelectItem value="debug">Debug</select_1.SelectItem>
                  <select_1.SelectItem value="optimize">Optimize</select_1.SelectItem>
                  <select_1.SelectItem value="generate">Generate</select_1.SelectItem>
                  <select_1.SelectItem value="review">Review</select_1.SelectItem>
          ...
          <div className="space-y-2">
            ...
            <textarea_1.Textarea placeholder="Additional context for the command" value={context} onChange={(e) => setContext(e.target.value)} rows={3}/>
          </div>

          <div className="space-y-2">
            <label className="text-sm font-medium">File Path (Optional)</label>
            <input_1.Input placeholder="Path to the file to operate on" value={filePath} onChange={(e) => setFilePath(e.target.value)}/>
          </div>

          <button_1.Button onClick={handleExecute} disabled={isLoading || !command.trim()} className="w-full gradient-cyber-primary hover:gradient-cyber-secondary">
            {isLoading ? (<>
