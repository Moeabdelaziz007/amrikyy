      ...
      <card_1.Card className="glass-card">
        ...
        <card_1.CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select_1.Select value={analysisType} onValueChange={setAnalysisType}>
              <select_1.SelectTrigger>
                <select_1.SelectValue />
              </select_1.SelectTrigger>
              <select_1.SelectContent>
                <select_1.SelectItem value="descriptive">Descriptive Statistics</select_1.SelectItem>
                <select_1.SelectItem value="correlation">Correlation Analysis</select_1.SelectItem>
                <select_1.SelectItem value="trend">Trend Analysis</select_1.SelectItem>
                <select_1.SelectItem value="outliers">Outlier Detection</select_1.SelectItem>
              </select_1.SelectContent>
            </select_1.Select>
          </div>

          <button_1.Button onClick={handleExecute} disabled={isLoading || !data.trim()} className="w-full gradient-cyber-primary hover:gradient-cyber-secondary">
            {isLoading ? (<>
