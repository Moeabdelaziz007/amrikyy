    ...
    <card_1.Card className="w-full">
      <card_1.CardHeader>
        ...
        <p className="text-muted-foreground">
          AI-powered system architecture designer for technical creativity and
          solution planning.
        </p>
      </card_1.CardHeader>
          ...
          <div>
            ...
            <select_1.Select value={complexity} onValueChange={setComplexity}>
              ...
              <select_1.SelectContent>
                ...
                <select_1.SelectItem value="complex">
                  Complex
                </select_1.SelectItem>
                <select_1.SelectItem value="enterprise">
                  Enterprise
                </select_1.SelectItem>
              </select_1.SelectContent>
            </select_1.Select>
          ...
          <div>
            ...
            <select_1.Select value={frontend} onValueChange={setFrontend}>
              ...
              <select_1.SelectContent>
                ...
                <select_1.SelectItem value="Angular">
                  Angular
                </select_1.SelectItem>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select_1.Select value={backend} onValueChange={setBackend}>
              ...
              <select_1.SelectContent>
                <select_1.SelectItem value="FastAPI">
                  FastAPI
                </select_1.SelectItem>
                <select_1.SelectItem value="Express">
                  Express
                </select_1.SelectItem>
          ...
          <div>
            ...
            <select_1.Select value={database} onValueChange={setDatabase}>
              ...
              <select_1.SelectContent>
                <select_1.SelectItem value="PostgreSQL">
                  PostgreSQL
                </select_1.SelectItem>
                <select_1.SelectItem value="MySQL">MySQL</select_1.SelectItem>
                <select_1.SelectItem value="MongoDB">
                  MongoDB
                </select_1.SelectItem>
              ...
              <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1 space-y-1">
                        <div>
                          Framework:{' '}
                          {
                            output.system_design?.architecture?.frontend
                              ?.framework
                          }
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      <div className="mt-1 space-y-1">
                        <div>
                          Framework:{' '}
                          {
                            output.system_design?.architecture?.backend
                              ?.framework
                          }
                        </div>
                        <div>
                        ...
                        <div>
                          Cache:{' '}
                          {output.system_design?.architecture?.backend?.cache}
                        </div>
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="mt-1 space-y-1">
                        <div>
                          Container:{' '}
                          {
                            output.system_design?.architecture?.infrastructure
                              ?.containerization
                          }
                        </div>
                        <div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                    {output.system_design?.components?.map(
                      (component, index) => (
                        <div
                          key={index}
                ...
                <div className="flex items-center gap-4 text-sm">
                  ...
                  <div>
                    ...
                    {output.estimated_development_time}
                  </div>
                </div>
              </div>
            </card_1.Card>
