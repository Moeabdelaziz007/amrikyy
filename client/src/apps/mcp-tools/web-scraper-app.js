      ...
      <card_1.Card className="glass-card">
        ...
        <card_1.CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input_1.Input placeholder=".article-content, #main, h1, etc." value={selector} onChange={(e) => setSelector(e.target.value)}/>
          ...
          <div className="space-y-2">
            ...
            <select_1.Select value={extractText.toString()} onValueChange={(value) => setExtractText(value === 'true')}>
              <select_1.SelectTrigger>
                <select_1.SelectValue />
              </select_1.SelectTrigger>
              <select_1.SelectContent>
                <select_1.SelectItem value="true">Yes - Text only</select_1.SelectItem>
                <select_1.SelectItem value="false">No - Include HTML</select_1.SelectItem>
              </select_1.SelectContent>
            </select_1.Select>
          </div>

          <button_1.Button onClick={handleExecute} disabled={isLoading || !url.trim()} className="w-full gradient-cyber-primary hover:gradient-cyber-secondary">
            {isLoading ? (<>
      ...
      {result && (<card_1.Card className="glass-card">
          ...
          <card_1.CardContent>
            <div className="space-y-4">
              ...
              {result.success && (<div className="grid grid-cols-2 gap-4">
