...
async function testAdvancedAISystem() {
  ...
  try {
    ...
    console.log(`📈 التقدم في التعلم: ${insights.learningProgress.length} موضوع`);
    ...
    console.log(`📝 متوسط الدقة: ${(performance.ml.averageAccuracy * 100).toFixed(1)}%`);
