...
exports.EnhancedChatPersona = void 0;
exports.getEnhancedChatPersona = getEnhancedChatPersona;
const storage_js_1 = require("./storage.js");
class EnhancedChatPersona {
    personas = new Map();
    ...
    getConversationContext(chatId, username) {
    ...
    async generateIntelligentResponse(message, chatId, username) {
    ...
    async generateContentCreatorResponse(message, context, persona) {
        const lowerMessage = message.toLowerCase();
...
What's your main content goal today? Are you looking to increase engagement, reach new audiences, or build brand awareness? Let's create something amazing together! 🚀`;
    ...
    async generateAnalyticsResponse(message, context, persona) {
        const lowerMessage = message.toLowerCase();
...
What metrics are you most curious about? Let's turn your data into actionable insights! 🔍`;
    ...
    async generateMainAssistantResponse(message, context, persona) {
        const lowerMessage = message.toLowerCase();
...
What's your main goal today? I'm here to make your social media management effortless! 🚀`;
    ...
    getContentCreatorSuggestions(context) {
        return [
    ...
    getAnalyticsSuggestions(context) {
        return [
    ...
    getMainAssistantSuggestions(context) {
        return [
            '🤖 Set up automation',
            '📝 Create content',
            '📊 Check performance',
    ...
    updateUserPreferences(chatId, preferences) {
...
exports.EnhancedChatPersona = EnhancedChatPersona;
// Export singleton instance
let enhancedChatPersona = null;
function getEnhancedChatPersona() {
