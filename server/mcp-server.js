...
exports.AuraOSMCPServer = void 0;
...
class AuraOSMCPServer {
    ...
    async multilingualAssistant(args) {
...
How are you feeling now? Would you like to talk about something specific?`
    ...
    estimateDevelopmentTime(complexity) {
        const timeEstimates = {
            simple: '2-4 weeks',
            medium: '1-3 months',
            complex: '3-6 months',
    ...
    generateExplanation(topic, difficulty) {
    ...
    generateExercises(topic, difficulty) {
        return [
    ...
    generatePracticalExercises(topic) {
        return [
    ...
    generateProjectSuggestions(topic) {
        return [
    ...
    generateCheckpoints(topic, difficulty) {
        return [
    ...
    estimateLearningTime(topic, difficulty) {
        const timeEstimates = {
            beginner: '2-4 weeks',
...
exports.AuraOSMCPServer = AuraOSMCPServer;
// Export for use in other modules
exports.default = AuraOSMCPServer;
