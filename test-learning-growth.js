...
class LearningGrowthTester {
  ...
  async startLearningTest() {
    ...
    console.log(
      '✅ Learning test started! Check console for real-time metrics.'
    );
  }
  ...
  updateLearningMetrics(message, response, responseTime) {
    ...
    this.learningMetrics.responseAccuracy = Math.min(
      0.95,
      this.learningMetrics.responseAccuracy + 0.001
    );
  ...
  logProgress() {
    ...
    console.log(
      `📊 Progress: ${this.messageCount} messages processed in ${elapsed.toFixed(1)}s (${messagesPerSecond.toFixed(2)} msg/s)`
    );
  }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  console.log(
    '  window.learningTester.startLearningTest() - Start learning test'
  );
  console.log(
    '  window.learningTester.stopLearningTest() - Stop learning test'
  );
  console.log(
    '  window.learningTester.logDetailedMetrics() - Show current metrics'
  );
