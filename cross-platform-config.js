...
const ReactNativeConfig = {
  ...
  metro: {
    ...
    transformer: {
      babelTransformerPath:
        './node_modules/metro-react-native-babel-transformer/lib/index.js',
  ...
  structure: {
    src: {
      ...
      assets: ['images', 'icons', 'fonts', 'sounds', 'videos'],
    },
  },
  ...
  testing: {
    ...
    detox: {
      ios: {
        binaryPath:
          './ios/build/Build/Products/Debug-iphonesimulator/AuraOS.app',
        build:
          'xcodebuild -workspace ios/AuraOS.xcworkspace -scheme AuraOS -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build',
        type: 'ios.simulator',
        device: {
          type: 'iPhone 14',
        },
